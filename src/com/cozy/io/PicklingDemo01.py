...
# 2、当我们要把对象从磁盘读到内存时，可以先把内容读到一个bytes，然后用pickle.loads()方法反序列化出对象，
...
# JSON和Python内置的数据类型对应：{}--dict   []--list   "string"--str   1234.56--int/float   true/false--True/False   null--None
